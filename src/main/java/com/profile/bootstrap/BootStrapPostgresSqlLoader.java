...
@Component
@Profile("prod")
public class BootStrapPostgresSqlLoader implements ApplicationListener<ContextRefreshedEvent> {

	private final ProductRepository productRepository;
	
	public BootStrapPostgresSqlLoader(ProductRepository productRepository) {
		super();
	...
	private Product getProduct(double price, String productName) {
		...
		product0.setDescription("Production product value : "+numberFormat.format(product0.getPrice()));
		return product0;
	}
}
